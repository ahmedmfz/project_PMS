                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php foreach(db_get_all("sections","`id_section`") as $row) :?>
                                    <tr>
                                    <th scope="row"><?php iteration(); ?></th>
                                        <td><?= $row['name_section']; ?></td>
                                        <td><?= $row['description_section']; ?></td>
                                        <td>
                                            <a href="<?php full_url("pages/category/edit.php?id=". $row['id_section'])?>" class="btn btn-info"><i class="far fa-edit"></i></a>
                                            <a href="<?php full_url("handlers/category/delete.php?id=". $row['id_section'])?>" class="btn btn-danger"><i class="far fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach?>
                            </tbody>
